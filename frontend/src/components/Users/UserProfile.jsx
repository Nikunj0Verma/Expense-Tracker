    ...
    <>
      <div className="max-w-4xl mx-auto my-10 p-8 bg-white rounded-lg shadow-md">
        <h1 className="mb-2 text-2xl text-center font-extrabold">
          Welcome <span className="text-pink-500 italic">{formik.values.username}</span>!
      ...
      {isSuccess && <AlertMessage type='success' message='Successfully Updated!!'/>}
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end mt-6">
            <button
              type="submit"
              className="bg-blue-500 hover:bg-blue-700 hover:cursor-pointer text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transform hover:-translate-y-0.5
