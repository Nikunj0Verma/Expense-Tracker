...
const UpdatePassword = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      ...
      {isSuccess && <AlertMessage type='success' message='Successfully Updated Password!!'/>}
        ...
        <button
          type="submit"
          className="w-full bg-blue-500 hover:bg-blue-700 hover:cursor-pointer transform hover:-translate-y-0.5
                    transition-all duration-500 text-white font-bold py-2 px-4 rounded"
        >
          Update Password
        </button>
      </form>
