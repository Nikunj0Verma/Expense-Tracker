...
const AddCategory = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="mt-4 bg-blue-500 hover:bg-blue-700 hover:cursor-pointer  text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transform hover:-translate-y-0.5
